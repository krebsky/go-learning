...
var CountMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"get\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"increase\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
	Bin: "",
}
...
func (_Count *CountCaller) Get(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Count.contract.Call(opts, &out, "get")
...
//
// Solidity: function get() view returns(uint256)
func (_Count *CountSession) Get() (*big.Int, error) {
	return _Count.Contract.Get(&_Count.CallOpts)
}

// Get is a free data retrieval call binding the contract method 0x6d4ce63c.
//
// Solidity: function get() view returns(uint256)
func (_Count *CountCallerSession) Get() (*big.Int, error) {
	return _Count.Contract.Get(&_Count.CallOpts)
}

// Increase is a paid mutator transaction binding the contract method 0xe8927fbc.
//
// Solidity: function increase() returns(uint256)
func (_Count *CountTransactor) Increase(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Count.contract.Transact(opts, "increase")
}

// Increase is a paid mutator transaction binding the contract method 0xe8927fbc.
//
// Solidity: function increase() returns(uint256)
func (_Count *CountSession) Increase() (*types.Transaction, error) {
	return _Count.Contract.Increase(&_Count.TransactOpts)
}

// Increase is a paid mutator transaction binding the contract method 0xe8927fbc.
//
// Solidity: function increase() returns(uint256)
func (_Count *CountTransactorSession) Increase() (*types.Transaction, error) {
	return _Count.Contract.Increase(&_Count.TransactOpts)
}
